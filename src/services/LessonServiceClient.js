...
const LESSON_CID_MID_API_URL = "https://beastmode-webdev-ysmolyar.herokuapp.com/api/course/CID/module/MID/lesson";
...
export default class LessonServiceClient {
    ...
    findAllLessonsForGivenModule(courseId, moduleId) {
        return fetch(
